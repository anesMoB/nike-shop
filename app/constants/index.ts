...
/* ***** NAVBAR  ***** */
export const headerLogo='./assets/images/header-logo.svg';
export const MenuIcon=hamburger;
...
export const HeroTexts=["Our Summer Collection","The New Arrival","Nike","Shoes","Discover stylish Nike arrivals,quality comfort, and innovation for your active life.","Shop now"]
...
export const PopularProductsTexts=["Our","Popular","Products","Experience top-notch quality and style with our sought-after selections. Discover a world of comfort, design, and value"]
...
export const TESTIMONIESTexts=["What Our ","Customers"," Say?","Hear genuine stories from our satisfied customers about their exceptional experiences with us."]
...
export const SUBSCRIPTIONTexts=["Sign Up for ","Updates"," & Newsletter","Sign Up"]
...
export const socialMedias=[
    ...
    {
        icon:"@/public/assets/icons/twitter.svg",
        href:"/"
    },
];

export const FooterTexts=["Get shoes ready for the new term at your nearest Nike store. Find Your perfect Size In Store. Get Rewards","Products","Help","Get in touch"]
export const Email="customer@nike.com";
export const PhoneNumber="+92554862354";
export const CopyRights="Copyright. All rights are reserved.";
export const Terms_Conditon="Terms & Conditions.";


export const Products=[
    "Air Force 1","Air Max 1","Air Jordan 1",
    "Air Force 2","Nike Waffle Racer","Nike Cortez"
];
export const Helps=[
    "About us","FAQs","How it works",
